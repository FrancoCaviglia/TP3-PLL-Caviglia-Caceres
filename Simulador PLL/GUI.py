...
ent_frr   = tk.Entry(master=frame_2_2_1_1, width=8)
...
ent_pulsos = tk.Entry(master=frame_2_2_1_1, width=8)
...
figura_1 = tk.Frame(master=frame_2_2_2, width=22, height=350, bg="white", relief=tk.RAISED, borderwidth=1)
figura_2 = tk.Frame(master=frame_2_2_2, width=22, height=350, bg="white", relief=tk.RAISED, borderwidth=1)
figura_3 = tk.Frame(master=frame_2_2_2, width=22, height=350, bg="white", relief=tk.RAISED, borderwidth=1)
