...
figura_1 = tk.Frame(master=frame_2_2_2, bg="white", relief=tk.RAISED, borderwidth=1)
figura_2 = tk.Frame(master=frame_2_2_2, bg="white", relief=tk.RAISED, borderwidth=1)
figura_3 = tk.Frame(master=frame_2_2_2, bg="white", relief=tk.RAISED, borderwidth=1)
...
def ejercicio_boton(i):
    ...
    for j in range(3):
        actualizar_figura([], [], '', '', 'Grafica '+estado_figuras[j][0], estado_figuras[j][1], j)
