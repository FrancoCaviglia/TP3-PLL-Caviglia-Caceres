...
Revisado por última vez el Jueves 23 de Julio a las 22:30 2020.
...
from enunciados import enunciados, respuestas
...
""" En este archivo se arma la interfaz gráfica. Para mostrar los resultados necesita las funciones que se encuentran en
    ...
    Label, Entry. Los atributos de cada uno de estos widget dan su geometría, aspecto y funcionalidad. 
    El árbol de inclusión es
   
    ventana _____ frame_1 _____ autores
              |             |__ título
              |             |__ materia
              |
              |__ frame_2 _____ frame_2_1 ___ frame ___ boton ___ ejercicio_i()
                            |
                            |__ frame_2_2 _____ frame_2_2_1 _____ frame_2_2_1_1 ___ parámetros
                                            |                 |__ frame_2_2_1_2 ___ figura
                                            |
                                            |__ frame_2_2_2 _____ figura_1 ___ canvas_widget_1
                                            |                 |__ figura_2 ___ canvas_widget_2
                                            |                 |__ figura_2 ___ canvas_widget_2
                                            |
                                            |__ frame_2_2_3 _____ frame ___ botones_grafica(frame, 0)
                                            |                 |__ frame ___ botones_grafica(frame, 1)
                                            |                 |__ frame ___ botones_grafica(frame, 2)
                                            |
                                            |__ frame_2_2_4 _____ ejercicio_enunciado
                                                              |__ ejercicio_respuesta
"""
...
def crear_figura(cord_x, cord_y, leyenda_x, leyenda_y, encabezado, logx):
    ...
    plt.title(r'\textrm{'+encabezado+'}', fontsize=11)
    plt.xlabel(r'\textrm{'+leyenda_x+'}', fontsize=11)
    plt.ylabel(r'\textrm{'+leyenda_y+'}', fontsize=11)
    #   plt.margins(0,0.05)
    plt.grid()
    plt.tight_layout()
...
lb_freq_v     = tk.Label(master=frame_2_2_1_1, text="Frecuencia natural VCO: ", fg="white", bg="black")
...
figura_1 = tk.Frame(master=frame_2_2_2, width=30, height=400, bg="white", relief=tk.RAISED, borderwidth=1)
figura_2 = tk.Frame(master=frame_2_2_2, width=30, height=400, bg="white", relief=tk.RAISED, borderwidth=1)
figura_3 = tk.Frame(master=frame_2_2_2, width=30, height=400, bg="white", relief=tk.RAISED, borderwidth=1)
figura_1.grid(row=0, column=0, padx = 2, pady = 3, sticky='NSWE')
figura_2.grid(row=0, column=1, padx = 2, pady = 3, sticky='NSWE')
figura_3.grid(row=0, column=2, padx = 2, pady = 3, sticky='NSWE')        
...
for i in range(3):
    ...
    for j in range(15):
        ...
        frame.grid(row=j, column=i, padx = 3, pady = 3, sticky = 'nsew')
