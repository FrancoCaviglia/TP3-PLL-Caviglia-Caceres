...
ventana.geometry(f'{screen_width}x{screen_height-20}')
...
def actualizar_dominio(dominio, i):
    ...
    if dominio == 'Tiempo (s)':
        ...
        actualizar_figura(x_fourier, y_fourier, dominio, leyendas[1], 'Gr\'afica '+estado[0], estado[1], i, logx = True)
...
ent_fase     = tk.Entry(master=frame_2_2_1_1, width=8)
...
ent_simb    = tk.Entry(master=frame_2_2_1_1, width=8)
lb_simb.grid(row=3, column=0,  sticky="w")
ent_simb.grid(row=3, column=1, sticky="e") 

lb_ganan    = tk.Label(master=frame_2_2_1_1, text="Ganancia de lazo VCO: ", fg="white", bg="black")
ent_ganan   = tk.Entry(master=frame_2_2_1_1, width=8)
...
ent_freq_v   = tk.Entry(master=frame_2_2_1_1, width=8)
lb_freq_v.grid(row=4, column=0,  sticky="w")
ent_freq_v.grid(row=4, column=1, sticky="e") 
...
entradas = [ent_muestras, ent_freq_m,  ent_freq,  ent_fase,  ent_amort,
            ent_freq_p,     ent_simb, ent_ganan, ent_freq_v, ent_filtro]
...
def botones_grafica(frame, j):
    ...
    button_5 = tk.Button(master=frame, text='Tiempo', width=9, height=1, bg="#C6C6C6", fg="black",
                         command = lambda : actualizar_dominio('Tiempo (s)', j) )
    button_5.grid(row=0, column=6, sticky = 'nsew')

    button_6 = tk.Button(master=frame, text='Frecuencia', width=9, height=1, bg="#C6C6C6", fg="black",
                         command = lambda : actualizar_dominio('Frecuencia (Hz)', j) )
    button_6.grid(row=0, column=7, sticky = 'nsew')
        
    button_7 = tk.Button(master=frame, text='Lissajous', width=9, height=1, bg="#C6C6C6", fg="black",
