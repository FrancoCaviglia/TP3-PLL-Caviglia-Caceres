...
def ejercicio_15():
    ...
    salida_1 = PLL(entrada, 'rc', sqrt(2)/2, wn, f0, Ts)[1]
    salida_2 = PLL(entrada, 'rc',       0.3, wn, f0, Ts)[1]
    salida_3 = PLL(entrada, 'rc',       2.0, wn, f0, Ts)[1]
...
def ejercicio_16():
    ...
    entrada  = unir_lista(fuente(f, Ts, 0, N//2), fuente(f, Ts, pi/2, N//2))
    _, error_1, _, salida_1 = PLL(entrada, 'rc', sqrt(2)/2, wn, f0, Ts)
    _, error_2, _, salida_2 = PLL(entrada, 'rc',       0.3, wn, f0, Ts)
    _, error_3, _, salida_3 = PLL(entrada, 'rc',         2, wn, f0, Ts)
...
def ejercicio_17():
    ...
    entrada  = unir_lista(fuente(f, Ts, 0, N//2), fuente(f, Ts, pi/2, N//2))
    _, _, salida_filtro, salida_vco = PLL(entrada, 'rc', xi, wn, f0, Ts)
...
def ejercicio_18():
    ...
    entrada  = unir_lista(fuente(f, Ts, 0, N//2), fuente(f, Ts, pi/2, N//2))
    _, _, salida_filtro, salida_vco = PLL(entrada, 'lead-lag activo', xi, wn, f0, Ts)
...
def ejercicio_20():
    ...
    _, _, salida_filtro, salida_vco = PLL(entrada, tipo, xi, wn, f0, Ts)
...
def ejercicio_26():
    ...
    _, salida_detector, salida_filtro, salida_vco = PLL(entrada, tipo, xi, wn, f0, Ts)
...
def ejercicio_42():
    ...
    _, filtro, _, onda_4 = PLL(onda_3, tipo, xi, omega, f0, Ts)
